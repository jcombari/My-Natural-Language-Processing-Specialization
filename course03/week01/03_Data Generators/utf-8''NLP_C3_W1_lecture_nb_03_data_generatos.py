...
a = [1, 2, 3, 4]
b = [0] * 10
print('inicialmente a =', a)
print('inicialmente b =', b)
...
def data_generator(batch_size, data_x, data_y, shuffle=True):
    ...
    while True:
        X = [*range(batch_size)] # We can create a list with batch_size elements. 
        Y = [*range(batch_size)] # We can create a list with batch_size elements. 
